...
router.post('/', async (req, res) => {
    try {
        ...
        // Basic validation
        if (!student_name || !dob || age < 0 || !mobile || !email) {
        ...
        const query = `
            INSERT INTO admission_form (
                ...
                guardian_address, guardian_mobile, guardian_email, cpt_month_year, cpt_marks, cpt_percentage, 
                cpt_average, foundation_month_year, foundation_marks, foundation_percentage, foundation_average, 
                ipcc_month_year, ipcc_marks, ipcc_percentage, ipcc_average, group1_month_year, group1_marks, 
